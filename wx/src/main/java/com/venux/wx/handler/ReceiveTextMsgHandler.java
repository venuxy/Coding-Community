package com.venux.wx.handler;

import com.venux.wx.redis.RedisUtil;
...
public class ReceiveTextMsgHandler implements WxChatMsgHandler {
    ...
    public String dealMsg(Map<String, String> messageMap) {
        ...
        redisUtil.setNx(numKey, fromUserName, 60L, TimeUnit.MINUTES);
        String numContent = "您当前的验证码是：" + num + "，60分钟内有效！";
